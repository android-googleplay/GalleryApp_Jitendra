...
public class LargeNativeAds {
    ...
    public void loadNativeAds(Activity activity, Dialog dialog) {
        if (PowerPreference.getDefaultFile().getBoolean(Constant.AdsOnOff, false) && PowerPreference.getDefaultFile().getBoolean(Constant.GoogleLargeNativeOnOff, false)) {
    ...
    public void showNativeAds(Activity activity, Dialog dialog, FrameLayout adLayout, TextView adSpace) {
        ...
        if (PowerPreference.getDefaultFile().getBoolean(Constant.AdsOnOff, true)) {
            ...
            if (dialog != null && !PowerPreference.getDefaultFile().getBoolean(Constant.LoaderNativeOnOff, false)) {
            ...
            } else if (PowerPreference.getDefaultFile().getBoolean(Constant.GoogleLargeNativeOnOff, true) && gNativeAd.size() > 0) {
                ...
                if (PowerPreference.getDefaultFile().getBoolean(Constant.QurekaOnOff, true) && PowerPreference.getDefaultFile().getBoolean(Constant.QurekaLargeNativeOnOff, true)) {
                    ...
                    Constant.setQureka(activity, Constant.QLARGE_COUNT, imageViewMain, imageViewBG, imageViewGif);
